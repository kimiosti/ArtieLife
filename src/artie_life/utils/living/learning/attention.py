...
POSITIVE_USER_REWARD: "float" = 1
NEGATIVE_USER_REWARD: "float" = -1
POSITIVE_DISTANCE_REWARD: "float" = 1
NEGATIVE_DISTANCE_REWARD: "float" = -1
POSITIVE_NEEDS_REWARD: "float" = 1
NEGATIVE_NEEDS_REWARD: "float" = 0
INPUT_LAYER_DIM: "int" = 2 * (len(EntityType) - 1) + MAX_INPUT_LENGTH
OUTPUT_LAYER_DIM: "int" = len(EntityType) - 2

def create_attention_model() -> "Sequential": # type: ignore[no-any-unimported]
